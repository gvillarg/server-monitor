...
- (void)setTooltipVisible:(BOOL)tooltipVisible animated:(BOOL)animated atTouchPoint:(CGPoint)touchPoint
{
    ...
    dispatch_block_t adjustTooltipPosition = ^{
        ...
        if (chartView)
        {
            ...
            self.tooltipView.frame = CGRectMake(convertedTouchPoint.x - ceil(self.tooltipView.frame.size.width * 0.5), 100, self.tooltipView.frame.size.width, self.tooltipView.frame.size.height);
